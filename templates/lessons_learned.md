...
- **R10**（实现完成必须分级）：任何 WI/ACC/RUN 不得只写 `pass`，必须声明完成等级：`fixture_contract / in_memory_domain / api_connected / db_persistent / integrated_runtime / owner_verified`
